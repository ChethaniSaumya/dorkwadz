...
let addressStaking = "0xa2d6D63DB8dbDD03f7F8C226509137767A8e2824";
...
let addressToken = "0xf4548AAc623d5dF21E881679F33dD5166C8dE8cd";
...
let addressNFT = "0xd28dEA39d24e95213F9498C4C22fB68DD34b24f8";
...
class Stake extends Component {
	...
	mm = async event => {
		...
		if (typeof window.ethereum !== 'undefined') {
			...
			window.open("https://metamask.app.link/dapp/nftstake.Dork Wadzchain.io/");
		}
	};
					...
					<div class="markBarMain">
						<div class="markBar">
							...
							<div class="markBarCon">
								<img src={pic2} />
								<div class="markBar2">
									<div class="num">{this.state._rewardsAmount} $DWADZ / Day</div>
							...
							<div class="markBarCon">
								<img src={pic3} />
								<div class="markBar2">
									<div class="num">{(this.state._myTokenAmount / 1000000000000000).toFixed(2)}Mn $DWADZ</div>
							...
							<div class="markBarCon">
								<img src={pic4} />
								<div class="markBar2">
									<div class="num">{this.state._newPendingRewards.toFixed(2)} $DWADZ</div>
									{this.state._newPendingRewards < 1 ?

										(<button class="nameClaim2" onClick={this.batchClaimRewards} disabled>CLAIM</button>) :
										(<button class="nameClaim" onClick={this.batchClaimRewards}>CLAIM</button>)}
								</div>
							</div>
